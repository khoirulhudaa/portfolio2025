...
const ModalSearch = ({ onClose }: ModalState) => {
    ...
    const profesional = [
        {
            title: "PT Karya Inovasi Digital",
            value: "https://kiraproject.id/"
        },
    ]
    ...
    const filteredProfesional = profesional.filter((data) =>
                            ...
                            <>
                                ...
                                {filteredProfesional.length > 0 && (
                                    <div className="border-b border-slate-300">
                                        ...
                                        {filteredProfesional.map((data, index) => (
